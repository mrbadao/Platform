...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: '/themes/helios/assets/css/style.css', containers: 1400, grid: { gutters: 48 } },
			'wide':		{ range: '-1680', href: '/themes/helios/assets/css/style-wide.css', containers: 1200 },
			'normal':	{ range: '-1280', href: '/themes/helios/assets/css/style-normal.css', containers: '100%', grid: { gutters: 36 } },
			'narrow':	{ range: '-960', href: '/themes/helios/assets/css/style-narrow.css', grid: { gutters: 32 } },
			'narrower': { range: '-840', href: '/themes/helios/assets/css/style-narrower.css', containers: '100%!', grid: { collapse: true } },
			'mobile':	{ range: '-736', href: '/themes/helios/assets/css/style-mobile.css', grid: { gutters: 20 }, viewport: { scalable: false } }
		},
		plugins: {
			layers: {
				config: {
